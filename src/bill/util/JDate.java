...
public class JDate {
	...
	/**
	 * @category 获取今天是这周的第几天 星期天算这个礼拜的第一天
	 */
	...
	public static void main(String[] args) {
		long time1 = 1366281950911l;
		long time2 = System.currentTimeMillis();
		String cost = costTime(time2, time1);
	...
	/**
	 * @category 计算从当前时间currentDate开始，满足条件 hourOfDay, minuteOfHour,
	 *           secondOfMinite的最近时间
	 * 
	 * @return
	 */
	...
	/**
	 * @category 计算从当前时间currentDate开始，满足条件dayOfWeek, hourOfDay, minuteOfHour,
	 *           secondOfMinite的最近时间
	 * 
	 * @return
	 */
